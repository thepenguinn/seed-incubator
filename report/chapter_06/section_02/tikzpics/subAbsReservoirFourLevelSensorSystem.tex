\subtikzpicturedef{subAbsReservoirFourLevelSensorSystem} {
    origin%
} {
    ...
    \ovrAbsSensorModuleDrawLabelName {#1-s2} {FSW}
    \ovrAbsSensorModuleDrawLabelName {#1-s3} {FSW}
...
\subtikzpictureactivate{subAbsReservoirFourLevelSensorSystem}
