...
Please refer to figures \ref{fig:74ls96Dip} and \ref{74ls96PinDiagram} for more information about
...
\begin{center}
    ...
    \begin{minipage}[c] {0.52\textwidth}
        ...
        \begin{tabularx} {\linewidth} {
            ...
            $\overline{\mbox{\texttt{MR}}}$ & Master reset. \\
            \texttt{PE} & Preset enable. \\
