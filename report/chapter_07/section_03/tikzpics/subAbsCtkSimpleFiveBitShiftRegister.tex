...
\subtikzpicturedef{subAbsCtkSimpleFiveBitShiftRegister} {
    ...
    \foreach \x in {1,...,\absSimpleFiveBitSRPinCountLS} {
        ...
        (#1-tmp) ++(0, -{(\x * \absCtkICPinGap)}) coordinate (#1-l\x)
        ;
    }
    ...
    \foreach \x in {1,...,\absSimpleFiveBitSRPinCountTS} {
        \draw [absCtkModule, line cap = round]
        (#1-tmp) ++({(\x * \absCtkICPinGap)}, 0) coordinate (#1-t\x)
        ;
    }

    \draw [absCtkModule]
    (#1-t1) ++(-\absCtkICPinGap, -\absCtkPinPad) coordinate (#1-topLeft)
    (#1-t\absSimpleFiveBitSRPinCountTS) ++(\absCtkICPinGap, -\absCtkICPinGap) coordinate (#1-topRight)
    (#1-l\absSimpleFiveBitSRPinCountLS) ++(\absCtkICPinGap, -\absCtkICPinGap) coordinate (#1-bottomLeft)
    ...
    \foreach \l/\p/\n in {
        ...
        (#1-t\n) ++(0, -\absCtkPinPad) node [below = 12pt] {\texttt{\l}}
        (#1-t\n) coordinate (#1-q\p)
        ;
    }
