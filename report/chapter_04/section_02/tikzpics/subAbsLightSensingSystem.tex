\subtikzpicturedef{subAbsLightSensingSystem} {
    ...
    \draw
    (#1-esp-l4 -| #1-s0-l0) coordinate (#1-b0)
    ;
    ...
    \ovrAbsSensorModuleDrawLabelName {#1-s1} {\texttt{LDR}}
    \ovrAbsSensorModuleDrawLabelName {#1-s0} {\texttt{LDR}}
    \ovrAbsSensorModuleDrawLabelName {#1-s2} {\texttt{LDR}}
    ...
    (#1-mux-l0) ++(\absCtkPinPad, 0) node [right = 4pt] {\texttt{C0}}
    (#1-mux-l1) ++(\absCtkPinPad, 0) node [right = 4pt] {\texttt{C1}}
    (#1-mux-l2) ++(\absCtkPinPad, 0) node [right = 4pt] {\texttt{C2}}
    ;
