\subtikzpicturedef{subAbsSoilMoistureSensorSystem} {
    ...
    \ovrAbsSensorModuleDrawLabelName {#1-s1} {SMS}
    \ovrAbsSensorModuleDrawLabelName {#1-s0} {SMS}
    \ovrAbsSensorModuleDrawLabelName {#1-s2} {SMS}
    \ovrAbsSensorModuleDrawLabelName {#1-s3} {SMS}
