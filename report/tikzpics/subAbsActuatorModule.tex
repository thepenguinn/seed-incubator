...
\subtikzpicturedef{subAbsActuatorModule} {
    ...
    (#1-northwest) ++(0.25, \absCtkPinPad) coordinate (#1-ct0)
    (#1-southwest) ++(0.25, -\absCtkPinPad) coordinate (#1-cb0)

    (#1-northeast) ++(\absCtkPinPad, -0.25) coordinate (#1-cr0)
    (#1-southeast) ++(\absCtkPinPad,  0.25) coordinate (#1-cr1)
