...
\def\abstractcontent {
    ...
    \textbf{temperature}, \textbf{lighting} and \textbf{soil moisture} by using ESP32 and
    integrating advanced IoT technologies.Wifi capabilities of ESP32 ensures
    the accumulation of collected data and presenting it to the user visually.
    %%
    The solution not only tries to improve the \emph{efficiency} and
    \emph{success rate of seed germination} but also reduces \emph{labor costs}
    and \emph{energy consumption}, offering a sustainable and reliable
    alternative to traditional incubation methods. Thus this implementation
    can potentially improve the \emph{crop yield} and \emph{quality} significantly.
    %%
