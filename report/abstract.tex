...
\def\subsubtitle{PROJECT PROPOSAL 01}
...
\def\abstractcontent {
    ...
    a \emph{low cost} and \emph{semi-automated} \textsc{Seed Incubation Plant}
    ...
    Wifi capabilities of \textsc{ESP32} ensures the
    accumulation of collected data and presenting
    it to the user, visually.
    This \textsc{ESP32} based system offers better \emph{accuracy}
